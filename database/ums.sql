...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 08, 2023 at 11:43 AM
...
CREATE TABLE IF NOT EXISTS `notifications` (
  `notiID` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `userID` bigint UNSIGNED NOT NULL,
  `notiContent` text COLLATE utf8mb4_general_ci,
  `notiFor` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(3, 'QA Coordinator (Academic)', '2023-03-26 09:04:13', '2023-03-26 09:04:13'),
