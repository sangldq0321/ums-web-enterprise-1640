...
@section('title', 'Add Idea Time Submit')
@section('content')
...
<form action="/idea/academicyear/add/save" method="POST">
    ...
    <div class="row col-cols-1 col-cols-lg-2 mb-5">
        <div class="col-6">
            <div class="form-floating mb-3 border border-dark rounded-2">
                <input type="datetime-local" class="form-control" placeholder="Semester" name="openDate">
                <label>Open Date</label>
            </div>
        </div>
        <div class="col-6">
            <div class="form-floating mb-3 border border-dark rounded-2">
                <input type="datetime-local" class="form-control" placeholder="Semester" name="closeDate">
